...
//	Field Types
	...
	switch ($field->type) {
		...
		case 'checkbox_dynamic':
			$html	 = preg_replace('/class=\"([^\"]*)(uk-input)([^\"]*)\"/', 'class="$1uk-checkbox $3"', $html);
		...
		case 'group_x':
			...
			$html	 = preg_replace('/class=\\"([^\\"]*)(cck_cgx_button)([^\\"]*)\\"/', 'class="$1 uk-float-right $3"', $html);
			...
			$html	 = preg_replace('/class=\\"([^\\"]*)(cck_wysiwyg_editor)([^\\"]*)\\"/', 'class="$1 uk-clearfix uk-margin $3"', $html);
...
// Fields layouts
	...
	if ($field->type == 'checkbox' || $field->type == 'upload_image') {
		$html	 = str_replace(array('class="checkbox ', 'class="checkbox"'), array('class="uk-checkbox ', 'class="uk-checkbox"'), $html);
